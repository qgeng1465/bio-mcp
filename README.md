...
>
> BioMCP 是一个开源的 **MCP 服务器**，让任意 AI 助手**零配置直连 26 个公开生物数据库**——文献、序列、比对、结构、富集、注释、基因组、互作、通路、变异、结构域、化合物、单细胞、糖组学、代谢组学、脂质组学、微生物组等全流程。

![MCP](https://img.shields.io/badge/MCP-Server-7c5cff?style=flat-square)
![Tools](https://img.shields.io/badge/Tools-40-0ea5e9?style=flat-square)
![Databases](https://img.shields.io/badge/Databases-26-22c55e?style=flat-square)
...
> 全部 40 个工具均已在开发期对真实公开数据库做端到端验证（40/40 通过）。
> All 40 tools were end-to-end validated against the real public databases (40/40 passed).
