...
DESCRIPTION = (
    ...
    "Zero-config direct access to 15 open academic databases / "
    "零配置直连 15 个公开学术数据库：PubMed/EuropePMC literature、"
    "NCBI sequences/BLAST/Taxonomy/GEO、PDB structures、AlphaFold predictions、"
    "UniProt annotations、GO/KEGG enrichment、Ensembl genome & homologs、"
    "STRING interactions、KEGG pathways、MyVariant/ClinVar variants、"
    "InterPro domains、PubChem/ChEMBL compounds、CELLxGENE single-cell、"
    "UCSC genomes. Cross-database validation via gene_full_profile / "
...
INSTRUCTIONS = (
    ...
    "- Genome 基因组：ensembl_gene_lookup('BRCA1')\n"
    "- Interactions 互作：string_interactions('TP53')\n"
    "- Variants 变异：variant_annotate('chr13:g.32911145G>A')\n"
